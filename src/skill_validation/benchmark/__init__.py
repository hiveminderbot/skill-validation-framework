...
class BenchmarkRunner:
    ...
    def run_benchmarks(self, tasks: Optional[List[Dict[str, Any]]] = None) -> List[BenchmarkResult]:
...
def benchmark_skill(skill_path: Path, tasks: Optional[List[Dict[str, Any]]] = None) -> tuple[List[BenchmarkResult], dict]:
