...
class SkillValidator:
    ...
    def __init__(self, skill_path: Path):
        ...
        self.skill_metadata: Optional[Dict[str, Any]] = None
    ...
    def _validate_skill_md(self) -> None:
        ...
        self.results.append(ValidationResult(
            ...
            message="YAML frontmatter present" if has_frontmatter else "YAML frontmatter missing",
        ))
        ...
        if has_frontmatter:
            try:
                ...
                self.results.append(ValidationResult(
                    ...
                    message="name field present" if "name" in metadata else "name field missing",
                ))
                
                self.results.append(ValidationResult(
                    test_name="skill_md_description_field",
                    passed="description" in metadata,
                    message="description field present" if "description" in metadata else "description field missing",
                ))
                ...
                if "description" in metadata:
                    ...
                    self.results.append(ValidationResult(
                        ...
                        passed=desc_quality,
                        message="Description has triggering guidance" if desc_quality else "Description lacks triggering guidance",
                    ))
        ...
        for script_file in scripts_dir.iterdir():
            if script_file.is_file():
                ...
                self.results.append(ValidationResult(
                    ...
                    message=f"{script_file.name} is executable" if is_executable else f"{script_file.name} not executable",
                ))
